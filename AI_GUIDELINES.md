...
use Simtabi\Laranail\Licence\Kit\Facades\LicenceKitFacade;
use Simtabi\Laranail\Licence\Kit\Services\*;
```
...
```markdown
I'm working with the Laravel Licensing package (laranail/license-kit).
Key facts:
...
```
I'm using Laravel Licensing (composer: laranail/license-kit).
...
use Simtabi\Laranail\Licence\Kit\Exceptions\{
...
// Models
use Simtabi\Laranail\Licence\Kit\Models\License;
use Simtabi\Laranail\Licence\Kit\Models\LicenseScope;          // Product/software scopes
use Simtabi\Laranail\Licence\Kit\Models\LicenseUsage;
use Simtabi\Laranail\Licence\Kit\Models\LicenseRenewal;
use Simtabi\Laranail\Licence\Kit\Models\LicenseTemplate;
...
use Simtabi\Laranail\Licence\Kit\Services\TrialService;
use Simtabi\Laranail\Licence\Kit\Services\LicenseTransferService;
use Simtabi\Laranail\Licence\Kit\Services\TransferApprovalService;
...
use Simtabi\Laranail\Licence\Kit\Services\EncryptedLicenseKeyGenerator;
use Simtabi\Laranail\Licence\Kit\Services\EncryptedLicenseKeyRegenerator;
...
// Enums
use Simtabi\Laranail\Licence\Kit\Enums\LicenseStatus;     // Pending, Active, Grace, Expired, Suspended, Cancelled
use Simtabi\Laranail\Licence\Kit\Enums\KeyType;            // Root, Signing
use Simtabi\Laranail\Licence\Kit\Enums\KeyStatus;          // Active, Revoked, Expired
use Simtabi\Laranail\Licence\Kit\Enums\UsageStatus;        // Active, Revoked
use Simtabi\Laranail\Licence\Kit\Enums\TrialStatus;        // Active, Expired, Converted, Cancelled
use Simtabi\Laranail\Licence\Kit\Enums\TransferStatus;     // Pending, Approved, Rejected, Expired, Completed, Cancelled, RolledBack
use Simtabi\Laranail\Licence\Kit\Enums\TransferType;       // UserToUser, UserToOrg, OrgToUser, OrgToOrg, Recovery, Migration
use Simtabi\Laranail\Licence\Kit\Enums\ApprovalStatus;     // Pending, Approved, Rejected, Expired
use Simtabi\Laranail\Licence\Kit\Enums\OverLimitPolicy;    // Reject, AutoReplaceOldest
use Simtabi\Laranail\Licence\Kit\Enums\TokenFormat;        // Paseto, Jws
use Simtabi\Laranail\Licence\Kit\Enums\AuditEventType;     // License/Usage/Key/Token/Transfer/Api events
...
// Jobs
use Simtabi\Laranail\Licence\Kit\Jobs\CheckExpiredTrialsJob;
