...
it('ships a single consolidated Boost guideline file', function (): void {
...
it('compiles the Boost guideline file via Blade without errors', function (): void {
...
it('mentions every covered topic in the consolidated guideline', function (): void {
    $contents = file_get_contents(GUIDELINES_DIR.'/'.GUIDELINE_FILE);
