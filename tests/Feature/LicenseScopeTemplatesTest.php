...
it('impedisce di riassegnare un template già collegato ad un altro scope', function (): void {
...
it('crea una licenza partendo da un template assegnato allo scope', function (): void {
    $scope = LicenseScope::create([
...
it('impedisce di usare template non assegnati allo scope', function (): void {
    $scope = LicenseScope::create([
