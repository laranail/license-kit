...
it('creates a license template with auto-generated slug', function (): void {
...
it('supports template inheritance', function (): void {
    $scope = LicenseScope::create([
        'name' => 'App',
    ]);
...
it('creates a license from template', function (): void {
    $scope = LicenseScope::create([
        'name' => 'App',
    ]);
...
it('creates a license from template slug', function (): void {
    $scope = LicenseScope::create([
        'name' => 'App',
    ]);
...
it('upgrades a license to higher tier', function (): void {
    $scope = LicenseScope::create([
        'name' => 'App',
    ]);
...
it('prevents downgrade to lower tier', function (): void {
    $scope = LicenseScope::create([
        'name' => 'App',
    ]);
...
it('gets available upgrades for a license', function (): void {
    $scope = LicenseScope::create([
        'name' => 'App',
    ]);
...
it('retrieves templates by scope', function (): void {
...
it('compares template tiers', function (): void {
