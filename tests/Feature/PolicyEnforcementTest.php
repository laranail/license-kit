...
test('enforces auto replace oldest policy', function (): void {
    testTime()->freeze();
    $license = $this->createLicense([
        'max_usages' => 2,
...
test('enforces usage inactivity auto revoke', function (): void {
    $license = $this->createLicense([
    ...
    $license->usages()->stale(7)->each(function ($usage): void {
...
test('enforces global fingerprint uniqueness', function (): void {
...
test('enforces per-license fingerprint scope', function (): void {
...
test('policy inheritance from config to license', function (): void {
...
test('offline token TTL inheritance', function (): void {
...
test('license status transitions follow business rules', function (): void {
    // Pending to Active
...
test('enforces usage limit once maximum seats are taken', function (): void {
...
test('grace period notification timing', function (): void {
    Event::fake();
