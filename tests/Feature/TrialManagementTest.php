...
it('can start trial', function (): void {
...
it('cannot start duplicate trial', function (): void {
    $fingerprint = 'test-device-123';
...
it('can convert trial to license', function (): void {
...
it('cannot extend trial twice', function (): void {
    $trial = $this->trialService->startTrial($this->license, 'test-device-123');
...
it('marks expired trials correctly', function (): void {
    $trial = $this->trialService->startTrial($this->license, 'test-device-123', 7);
...
it('respects feature restrictions', function (): void {
    $trial = $this->trialService->startTrial(
        license: $this->license,
        fingerprint: 'test-device-123',
        durationDays: 7,
...
it('enforces limitations', function (): void {
    $trial = $this->trialService->startTrial(
        license: $this->license,
        fingerprint: 'test-device-123',
        durationDays: 7,
...
it('calculates trial stats correctly', function (): void {
