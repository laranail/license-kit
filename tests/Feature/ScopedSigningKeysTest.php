...
test('can find active signing key by scope', function (): void {
    // Create root key
    $rootKey = LicensingKey::generateRootKey('test-root');
    $rootKey->save();
...
test('license uses scoped signing key for token generation', function (): void {
    // Create root key
    $rootKey = LicensingKey::generateRootKey('test-root');
    $rootKey->save();
...
test('falls back to global key when scoped key not found', function (): void {
    // Create root key
    $rootKey = LicensingKey::generateRootKey('test-root');
    $rootKey->save();
...
test('multiple software can have their own signing keys', function (): void {
    // Create root key
    $rootKey = LicensingKey::generateRootKey('test-root');
    $rootKey->save();
...
test('can programmatically create scoped signing key', function (): void {
