...
class LicenseController extends ApiController
{
    ...
    public function activate(Request $request): JsonResponse
    {
        ...
        if (($response = $this->guardLicenseState($license)) instanceof JsonResponse) {
            return $response;
        }
    ...
    public function deactivate(Request $request): JsonResponse
    {
        ...
        if (! $usage instanceof LicenseUsage) {
     ...
     */
    protected function validationErrorResponse(ValidationException $exception): never
    {
    ...
    protected function extractTokenDetails(string $token): array
    {
        ...
        $refreshAfter = $expiresAt instanceof Carbon
