...
class ExportKeysCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        if (! $rootKey instanceof LicensingKey) {
            $this->line(__('laranail-license-kit::license-kit.export.no_root'));

            return 2;
        }

        if ($signingKeys->isEmpty()) {
            $this->line(__('laranail-license-kit::license-kit.export.no_signing'));
        }
    ...
    private function exportAsPem(LicensingKey $rootKey, $signingKeys, $includeChain): string
    {
        ...
        $this->line(__('laranail-license-kit::license-kit.export.pem_not_applicable'));
