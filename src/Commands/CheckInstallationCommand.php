...
{
    protected $signature = 'laranail::license-kit.check';

    protected $description = 'Verify the licensing package installation status';

    /** @var list<string> */
    protected array $commandAliases = ['licensing:check'];
    ...
    public function handle(): int
    {
        ...
        $hasFailure = collect($checks)->contains(fn ($row): bool => $row[1] === 'FAIL');
    ...
    protected function checkTables(): array
    {
        ...
        return array_map(fn (string $table): array => Schema::hasTable($table)
