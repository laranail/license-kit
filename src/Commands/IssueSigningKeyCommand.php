...
class IssueSigningKeyCommand extends Command
{
    ...
    public function handle(
        ...
        if (! $rootKey instanceof LicensingKey) {
            $this->line(__('laranail-license-kit::license-kit.issue_signing.no_root'));
        ...
        if ($scopeOption = $this->option('scope')) {
            ...
            if (! $licenseScope instanceof LicenseScope) {
                $this->line(__('laranail-license-kit::license-kit.issue_signing.scope_not_found', ['scope' => $scopeOption]));
                $this->line(__('laranail-license-kit::license-kit.issue_signing.available_scopes'));
                LicenseScope::active()->each(function ($scope): void {
                    $this->line(__('laranail-license-kit::license-kit.issue_signing.scope_line', ['slug' => $scope->slug, 'name' => $scope->name]));
                });
        ...
        if ($this->option('days') !== null) {
            ...
            if (! is_numeric($daysOption) || (int) $daysOption <= 0) {
                $this->line(__('laranail-license-kit::license-kit.issue_signing.days_positive'));
        ...
        $this->line(__('laranail-license-kit::license-kit.issue_signing.generating'));
        if ($this->output->isVerbose()) {
            $this->line(__('laranail-license-kit::license-kit.issue_signing.generating_rsa'));
        }
        ...
        try {
            ...
            if ($this->output->isVerbose()) {
                $this->line(__('laranail-license-kit::license-kit.issue_signing.creating_cert'));
                $this->line(__('laranail-license-kit::license-kit.issue_signing.signing_cert'));
            }
            ...
            if ($this->output->isVerbose()) {
                $this->line(__('laranail-license-kit::license-kit.issue_signing.storing'));
            }
            ...
            $this->line(__('laranail-license-kit::license-kit.issue_signing.issued'));
            $this->line(__('laranail-license-kit::license-kit.issue_signing.key_id', ['kid' => $kid]));
            if ($licenseScope instanceof LicenseScope) {
                $this->line(__('laranail-license-kit::license-kit.issue_signing.scope', ['name' => $licenseScope->name, 'slug' => $licenseScope->slug]));
            } else {
                $this->line(__('laranail-license-kit::license-kit.issue_signing.scope_global'));
            }
            $this->line(__('laranail-license-kit::license-kit.issue_signing.valid_for', ['days' => $validForDays]));

            return self::SUCCESS;
        } catch (Exception $e) {
            $this->line(__('laranail-license-kit::license-kit.issue_signing.failed', ['error' => $e->getMessage()]));
